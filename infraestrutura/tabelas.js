class Tabelas {
    ...
    criarAtendimentos(){
        const sql = 'CREATE TABLE IF NOT EXISTS Atendimentos (id int PRIMARY KEY AUTO_INCREMENT, cliente_id int NOT NULL, produto varchar(20),servico varchar(20) NOT NULL, status varchar(20) NOT NULL,observacao varchar(50), pagamento_id int NOT , CONSTRAINT fk_clienAten FOREIGN KEY (cliente_id) REFERENCES Clientes (cliente_id)'
